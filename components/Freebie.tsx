...
const Freebie = () => {
  return (
    <section className="relative overflow-x-clip max-lg:px-8!">
      <div className="container bg-(--primary-800) rounded-2xl py-[5.2rem]! px-32! max-lg:px-8! max-lg:py-[4.8rem] flex items-center justify-between max-lg:flex-col">
        <div className="max-w-150 max-lg:max-w-full max-lg:w-full flex flex-col gap-[1.2rem]">
          <h2>
